...
- The form is deliberately lightweight — no document upload in this stage. Document upload is a separate, deferred story ([[HU24-SupportingDocuments\|HU 24]]).
...
- A mobile-optimized version of this flow is tracked as [[NFR-MobileLeadExperience\|Mobile Lead Experience (NFR)]].
