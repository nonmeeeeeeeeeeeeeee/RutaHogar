# HU 23 — Scoring Parameter Configuration
...
- A parameter change is a recalculation trigger for [[NFR-ImmutableEvaluationHistory\|Immutable Evaluation History (NFR)]].
- **Numbering note:** this story was `HU 15` under the E4 plan; the updated sprint plan renumbers it to `HU 23` (still Sprint 3).
