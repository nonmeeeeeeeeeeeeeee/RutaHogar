# HU 21 - Visualización de mapa de accesibilidad inmobiliaria

> **🗓 Planificada - Sprint 3.** Mapa de la Región Metropolitana con los sectores clasificados según la capacidad financiera del lead, para ver visualmente dónde podría comprar hoy y dónde está fuera de alcance.

> ⚠️ **Atención:** esta historia es idéntica a [[HU14-mapa-accesibilidad|HU 14]] (Sprint 2) en el documento fuente del backlog. Ambas se documentan tal como aparecen y ninguna suma o resta SP a su sprint. Pendiente de confirmación del equipo.
...
- Duplicada con [[HU14-mapa-accesibilidad|HU 14]]; la actualización dinamica del mapa es [[HU22-actualizacion-mapa-accesibilidad|HU 22]].
