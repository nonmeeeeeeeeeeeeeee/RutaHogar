...
| **Required by** | [[HU2-LeadPrioritization\|HU 2]], [[HU4-ImprovementPlan\|HU 4]] |
...
- The immutable record described in E5 maps to the `evaluations` table. See [[../Database/evaluations\|evaluations]] for the full schema, including `algoritmo_version` and `component_breakdown` columns. Full versioning/lineage is expanded in [[NFR-ImmutableEvaluationHistory\|Immutable Evaluation History (NFR)]].
