# HU 10 — Lead–Project Matching for Sales Executives
...
- **Numbering note:** this story was `HU 13` under the E4 plan; the updated sprint plan renumbers it to `HU 10` (still Sprint 1).
