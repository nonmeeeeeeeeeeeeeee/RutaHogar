# HU 12 — Commercial Derivation and Integration System
...
- **Numbering note:** documented as `HdU 5` (CRM Integration) in the E2 informe, as `HU 4` under the E4 plan; the updated sprint plan renumbers it to `HU 12` (still Sprint 2) and raises its category from Desirable to Important.
