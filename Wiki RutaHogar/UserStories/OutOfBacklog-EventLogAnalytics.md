# Out of Backlog — Event-Log Metrics Visualization and Analysis

> ⚠️ **Out of the updated backlog.** This story does not appear anywhere in the updated sprint plan ("HUs para Sprint 1" document), although it was previously planned as part of Sprint 1. Kept for reference; it was `HU 23` under the E4 plan. Re-prioritize explicitly if it is still wanted.

Lets a real estate admin visualize the application's event logs (sign-in clicks, account creation, pre-assessments, user age, etc.) and derive metrics, charts, and preliminary analysis — while respecting consent.
...
| **Required by** | [[OutOfBacklog-DemographicVisualization\|Demographic Visualization (out of backlog)]] |
...
- This feeds the demographic/socioeconomic reporting in [[OutOfBacklog-DemographicVisualization\|Demographic Visualization (out of backlog)]] and the conversion dashboard [[HU16-ConversionDashboard\|HU 16]].
